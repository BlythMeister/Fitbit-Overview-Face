...
function hasProgressStat(props) {
  try {
    ...
    return progressStats.includes(statsTL) || progressStats.includes(statsBL) || progressStats.includes(statsTM) || progressStats.includes(statsBM) || progressStats.includes(statsTR) || progressStats.includes(statsBR);
  } catch (e) {
...
function mySettings(props) {
  ...
  if (modelId === "38") {
    availiableStats = [
      ...
      { value: "steps", name: "Steps" },
      { value: "distance", name: "Distance" },
      { value: "NONE", name: "Floors (Not Supported On Versa Lite)" },
      { value: "calories", name: "Calories" },
      { value: "activeMinutes", name: "Active Zone Minutes" },
      { value: "BATTERY", name: "Battery" },
    ];
