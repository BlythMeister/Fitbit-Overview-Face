...
function mySettings(props) {
  ...
  let availableStats = [
    ...
    { value: "WEATHER-THISHOUR", name: "Weather This Hour" },
    { value: "WEATHER-NEXTHOUR", name: "Weather Next Hour" },
    { value: "WEATHER-RAIN", name: "Weather Rain Chance Today" },
  ];
  ...
  let availableStatsBottomMiddleOnly = [
    ...
    { value: "WEATHER-THISHOUR", name: "Weather This Hour" },
    { value: "WEATHER-NEXTHOUR", name: "Weather Next Hour" },
    { value: "WEATHER-TODAY", name: "Weather Today" },
    { value: "WEATHER-RAIN", name: "Weather Rain Chance Today" },
  ];
  ...
  return (
    <Page>
      ...
      {(hasActivity(props, "WEATHER") || hasActivity(props, "WEATHER-THISHOUR") || hasActivity(props, "WEATHER-NEXTHOUR") || hasActivity(props, "WEATHER-TODAY") || hasActivity(props, "WEATHER-LOCATION") || hasActivity(props, "WEATHER-AGE") || hasActivity(props, "WEATHER-RAIN")) && (
        <Section title="Weather">
          <Select label="Refresh Interval" settingsKey="weatherRefreshInterval" options={weatherRefresh} />
          {(hasActivity(props, "WEATHER") || hasActivity(props, "WEATHER-THISHOUR") || hasActivity(props, "WEATHER-NEXTHOUR") || hasActivity(props, "WEATHER-TODAY")) && <Select label="Temperature Unit" settingsKey="weatherTemperatureUnit" options={temperatureUnits} />}
        </Section>
      )}
      ...
      {hasActivity(props, "WEATHER-THISHOUR") && (
        <Section title="Weather This Hour Colour">
          <ColorSelect settingsKey="weatherThisHourColour" colors={colourSet} />
        </Section>
      )}

      {hasActivity(props, "WEATHER-NEXTHOUR") && (
        <Section title="Weather Next Hour Colour">
          <ColorSelect settingsKey="weatherNextHourColour" colors={colourSet} />
        </Section>
      )}

      {hasActivity(props, "WEATHER-TODAY") && (
        <Section title="Weather Today Colour">
          <ColorSelect settingsKey="weatherTodayColour" colors={colourSet} />
        </Section>
      )}
      ...
      {hasActivity(props, "WEATHER-RAIN") && (
        <Section title="Weather Rain Chance Colour">
          <ColorSelect settingsKey="weatherRainColour" colors={colourSet} />
        </Section>
      )}
